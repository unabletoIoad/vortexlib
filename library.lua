...
local Icons = useStudio and require(script.Parent.icons) or loadWithTimeout('https://raw.githubusercontent.com/unabletoIoad/vortexlib/main/icons.lua')
-- Variables
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
		LoadingFrame.Version.Text = "Vortex Hub"
	end
		...
		task.spawn(function()
			while true do
				...
				RayfieldLibrary:Notify({
					Title = "Vortex Hub",
					Content = "Thanks for using Vortex Hub!",
					Duration = 7,
					Image = 4370033185,
				})
			end
